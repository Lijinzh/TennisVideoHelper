(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    '安装包由公开 GitHub Release 提供；点击即可下载。若网络连接不稳定，也可以进入发布页后重新下载。': 'The installer is provided through the public GitHub Release. If the connection is unstable, open the release page and retry the download.',
    ...
    '下载 TennisVideoHelper-Setup-0.1.3.exe': 'Download TennisVideoHelper-Setup-0.1.3.exe', '查看 v0.1.3 发布页 →': 'View the v0.1.3 release →',
    ...
    '安装包托管在公开 GitHub Release。可以尝试切换网络、稍后重试，或者先进入 v0.1.3 发布页再点击安装包文件。': 'The installer is hosted on the public GitHub Release. Try another network, retry later, or open the v0.1.3 release page and select the installer asset.',
