...
from tennis_video_helper.media.probe import parse_probe_payload, probe_media, scan_videos
from tennis_video_helper.core.models import MediaProbeError
...
def test_probe_media_calls_ffprobe_with_argument_list(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("tennis_video_helper.media.probe.subprocess.run", fake_run)
...
def test_probe_media_explains_missing_moov_atom(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("tennis_video_helper.media.probe.subprocess.run", fail_probe)
